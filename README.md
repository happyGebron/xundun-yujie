...
[English](README.en.md) · `V1.1.0` · Apache-2.0
...
| 指挥界面 | 连续式坝段数字孪生工作面、风险检查器、协同控制与任务事件回放 |
...
V1.1.0 关注软件原型闭环与高密度指挥界面的可用性。后续如需对接相机、热成像、飞控、机器人底盘、消息总线或工程数据平台，应通过独立适配层接入，并补充数据治理、权限、审计、容错和现场安全验证。
